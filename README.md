...
- 版本：v5.6.2（macOS 与 Windows 已对齐）；Android v2.0.3
- 🍎 macOS · Apple 芯片（M1/M2/M3/M4…）：[GPT Mini v5.6.2（Apple Silicon 版）](https://github.com/CoimgRain/Codex-Mini/releases/download/codex-mini-v5.6.2/GPTMini_v5.6.2_macOS_AppleSilicon.dmg)
- 💻 macOS · Intel 芯片（x86）：[GPT Mini v5.6.2（Intel Mac 版）](https://github.com/CoimgRain/Codex-Mini/releases/download/codex-mini-v5.6.2/GPTMini_v5.6.2_macOS_Intel.dmg)
- 🪟 Windows（10 / 11，64 位）：[GPT Mini v5.6.2（Windows 版）](https://github.com/CoimgRain/Codex-Mini/releases/download/codex-mini-v5.6.2/GPTMini_v5.6.2_Windows_Setup.exe)
- 🤖 **Android 手机专用**：[GPT Mini Android v2.0.3（通用 WebView 版）](https://github.com/CoimgRain/Codex-Mini/releases/download/codex-mini-v5.6.2/GPTMini_Android_v2.0.3.apk)
...
- Release 页面：[codex-mini-v5.6.2](https://github.com/CoimgRain/Codex-Mini/releases/tag/codex-mini-v5.6.2)
...
### 最新版 V5.6.2（Mac / Windows）

- **Windows 过程显示修复**：恢复推理摘要和工具调用等回复过程的显示
- **Windows 消息持久化修复**：刷新网页或退出重开后，刚发送的用户消息不再消失
- **微信支付入口临时调整**：Mac 和 Windows 暂时只保留方式一网页支付，方式二入口隐藏但后续可恢复
...
官方 Windows 安装包已经随最新 Release 一起发布，文件名是 `GPTMini_v5.6.2_Windows_Setup.exe`。Windows 版支持在 Windows 桌面环境中运行 GPT Mini 控制面板，并保留手机网页控制、线程列表、CDP 受控 Codex、局域网访问、Pro 外网入口和一键自动更新等核心能力。
...
1. 按系统下载对应的 `GPTMini_v5.6.2_macOS_AppleSilicon.dmg`、`GPTMini_v5.6.2_macOS_Intel.dmg`、`GPTMini_v5.6.2_Windows_Setup.exe`；安卓手机用户下载 `GPTMini_Android_v2.0.3.apk`
