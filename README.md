...
- 版本：v5.7.2（macOS 与 Windows 已对齐）；Android v2.0.3
- 🍎 macOS · Apple 芯片（M1/M2/M3/M4…）：[GPT Mini v5.7.2（Apple Silicon 版）](https://github.com/CoimgRain/Codex-Mini/releases/download/codex-mini-v5.7.2/GPTMini_v5.7.2_macOS_AppleSilicon.dmg)
- 💻 macOS · Intel 芯片（x86）：[GPT Mini v5.7.2（Intel Mac 版）](https://github.com/CoimgRain/Codex-Mini/releases/download/codex-mini-v5.7.2/GPTMini_v5.7.2_macOS_Intel.dmg)
- 🪟 Windows（10 / 11，64 位）：[GPT Mini v5.7.2（Windows 版）](https://github.com/CoimgRain/Codex-Mini/releases/download/codex-mini-v5.7.2/GPTMini_v5.7.2_Windows_Setup.exe)
- 🤖 **Android 手机专用**：[GPT Mini Android v2.0.3（通用 WebView 版）](https://github.com/CoimgRain/Codex-Mini/releases/download/codex-mini-v5.7.2/GPTMini_Android_v2.0.3.apk)
...
- Release 页面：[codex-mini-v5.7.2](https://github.com/CoimgRain/Codex-Mini/releases/tag/codex-mini-v5.7.2)
